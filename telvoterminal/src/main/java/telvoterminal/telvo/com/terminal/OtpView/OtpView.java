package telvoterminal.telvo.com.terminal.OtpView;

/**
 * Created by Invariant on 9/4/18.
 */
...
public class OtpView extends LinearLayout {
    private RobotoRegularEditText mOtpOneField, mOtpTwoField, mOtpThreeField, mOtpFourField,
    ...
    private void setFocusListener() {
        OnFocusChangeListener onFocusChangeListener = new OnFocusChangeListener() {
            @Override public void onFocusChange(View v, boolean hasFocus) {
                mCurrentlyFocusedEditText = (RobotoRegularEditText) v;
