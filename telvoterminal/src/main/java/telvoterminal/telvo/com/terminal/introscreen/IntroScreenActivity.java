package telvoterminal.telvo.com.terminal.introscreen;
...
public class IntroScreenActivity extends AppCompatActivity {
    ...
    private ApplicationPreferences prefManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_intro_screen);
        prefManager = new ApplicationPreferences(this);
    ...
    private void addBottomDots(int currentPage) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setTextColor(ContextCompat.getColor(getBaseContext(),
        ...
        if (dots.length > 0) {
            ...
            dots[currentPage].setTextColor(
                    ContextCompat.getColor(getBaseContext(), R.color.dot_active));
    ...
    private void launchHomeScreen() {
        prefManager.setIntroPageVisitStatus(true);
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                ...
                btnNext.setText(getString(R.string.intro_next_text));
    ...
    private void changeStatusBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            window.setStatusBarColor(IntroScreenActivity.this.
